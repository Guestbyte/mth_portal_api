        ...
        <div class="box-cards">
            ...
            <div class="card-home">
                ...
                <div class="card-home-inner">
                    <h2><?php the_sub_field('titulo_card'); ?></h2>
...
<section id="nossos-numeros" class="nossos-numeros">
    <div class="inner">
        <h1><?php the_field('titulo_nossos_numeros'); ?></h1>
...
<section class="loja-home">
    <div class="inner">
        <h1><?php the_field('titulo_carrossel_produtos'); ?></h1>        
        <?php
...
<section class="novidades">
    <div class="inner">
        <h1>Fique por dentro das novidades do Mathema!</h1>
