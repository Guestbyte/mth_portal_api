                ...
                <div id="3anos" class="filtro-idade-item idade">
                        ...
                        <div class="material-ciranda-conteudo">
                            <div class="material-ciranda-item">
                                <div class="material-ciranda-item-inner">
                                    <?php if (have_rows('lista_material_3_prof')) : $i = 0;
                                        while (have_rows('lista_material_3_prof')) : the_row();
                                            $i++; ?>
                    ...
                    <div id="3anosalun" class="filtro-tipo-item tipo3 btns-aluno3" style="display:none">
                        <div class="material-ciranda-conteudo">
                            <div class="material-ciranda-item">
                                <div class="material-ciranda-item-inner">
                                    <?php if (have_rows('lista_material_3_aluno')) : $i = 0;
                                        while (have_rows('lista_material_3_aluno')) : the_row();
                                            $i++; ?>
                                    <a class="btn-material-ciranda btn-material-ciranda-<?php echo $i; ?>" data-fancybox
                ...
                <div id="4anos" class="filtro-idade-item idade" style="display:none">
                    ...
                    <div id="4anosprof" class="filtro-tipo-item tipo4 btns-prof">
                        <div class="material-ciranda-conteudo">
                            <div class="material-ciranda-item">
                                <div class="material-ciranda-item-inner">
                                    <?php if (have_rows('lista_material_4_prof')) : $i = 0;
                                        while (have_rows('lista_material_4_prof')) : the_row();
                                            $i++; ?>
                                    <a class="btn-material-ciranda btn-material-ciranda-<?php echo $i; ?>" data-fancybox
                    ...
                    <div id="4anosalun" class="filtro-tipo-item tipo4 btns-aluno45" style="display:none">
                        <div class="material-ciranda-conteudo">
                            <div class="material-ciranda-item">
                                <div class="material-ciranda-item-inner">
                                    <?php if (have_rows('lista_material_4_aluno')) : $i = 0;
                                        while (have_rows('lista_material_4_aluno')) : the_row();
                                            $i++; ?>
                                    <a class="btn-material-ciranda btn-material-ciranda-<?php echo $i; ?>" data-fancybox
                ...
                <div id="5anos" class="filtro-idade-item idade" style="display:none">
                    ...
                    <div id="5anosprof" class="filtro-tipo-item tipo5 btns-prof">
                        <div class="material-ciranda-conteudo">
                            <div class="material-ciranda-item">
                                <div class="material-ciranda-item-inner">
                                    <?php if (have_rows('lista_material_5_prof')) : $i = 0;
                                        while (have_rows('lista_material_5_prof')) : the_row();
                                            $i++; ?>
                                    <a class="btn-material-ciranda btn-material-ciranda-<?php echo $i; ?>" data-fancybox
                    ...
                    <div id="5anosalun" class="filtro-tipo-item tipo5 btns-aluno45" style="display:none">
                        <div class="material-ciranda-item">
                            <div class="material-ciranda-item-inner">
                                <?php if (have_rows('lista_material_5_aluno')) : $i = 0;
                                    while (have_rows('lista_material_5_aluno')) : the_row();
                                        $i++; ?>
                                <a class="btn-material-ciranda btn-material-ciranda-<?php echo $i; ?>" data-fancybox
    ...
    <div class="inner">
        ...
        <div class="resultados-ciranda-slide-2 owl-emenda">
            <div id="owl-resultados-ciranda" class="owl-carousel owl-theme">
                <!-- loop que carrega os resultados -->
                <?php if (have_rows('itens_resultados')) : $i = 0;
                    while (have_rows('itens_resultados')) : $i++;
                        the_row(); ?>
                <!-- ITEM -->
...
// [25/10/2019 - Fernando] - init
// [04/02/2020 - Christiano] 
// [10/02/2020 - Fernando] - correção campos, melhorias, class Mailchimp (footer.php)

var form1 = ".janela-modal-sobre-inner";
$(form1 + " .wpcf7-submit").click((event) => {

    var form = new FormData();
    form.append("email_address", $(form1 + " input[name=mc4wp-EMAIL]").val());
    form.append("merge_fields[NOME]", $(form1 + " input[name=mc4wp-NAME]").val());
    form.append("merge_fields[TELEFONE]", $(form1 + " input[name=telefone]").val());
    form.append("merge_fields[CELULAR]", $(form1 + " input[name=celular]").val());
    form.append("merge_fields[CARGO]", $(form1 + " input[name=cargo]").val());
    form.append("merge_fields[INSTITUICA]", $(form1 + " input[name=instituicao]").val());
    form.append("merge_fields[CIDADE]", $(form1 + " input[name=cidade]").val());
    form.append("merge_fields[ESTADO]", $(form1 + " select[name=estado]").val());
    form.append("merge_fields[N_ALUNOS]", $(form1 + " select[name=numero-alunos]").val());
    form.append("tags[]", ["Ciranda visualização"]);
    $(form1 + " input[name='fase-escolar[]']").map((key, input) => {
        if (input.checked) {
            form.append("tags[]", [input.value]);
        };
    });
    ...
    setTimeout(() => {
        document.getElementById("mensagem-sucesso").innerHTML =
            "Obrigado! <br>O acesso ao material demonstrativo do Ciranda foi enviado ao seu e-mail";
    }, 2500);

})

var form2 = ".quero-ciranda-2";
$(form2 + " .wpcf7-submit").click((event) => {

    var form = new FormData();
    form.append("email_address", $(form2 + " input[name=mc4wp-EMAIL]").val());
    form.append("merge_fields[NOME]", $(form2 + " input[name=mc4wp-NAME]").val());
    form.append("merge_fields[TELEFONE]", $(form2 + " input[name=telefone]").val());
    form.append("merge_fields[CELULAR]", $(form2 + " input[name=telefone]").val());
    form.append("merge_fields[CARGO]", $(form2 + " input[name=cargo]").val());
    form.append("merge_fields[INSTITUICA]", $(form2 + " input[name=instituicao]").val());
    form.append("merge_fields[CIDADE]", $(form2 + " input[name=cidade]").val());
    form.append("merge_fields[ESTADO]", $(form2 + " select[name=estado]").val());
    form.append("merge_fields[N_ALUNOS]", $(form2 + " select[name=numero-alunos]").val());
    form.append("merge_fields[N_ALUNOS]", $(form2 + " select[name=numero-alunos]").val());
    $(form2 + " input[name='fase-escolar[]']").map((key, input) => {
        if (input.checked) {
            form.append("tags[]", [input.value]);
        };
    });
