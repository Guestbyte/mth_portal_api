...
<section class="download-ciranda">
    <div class="inner">
        ...
        <div id="abas-vertical">  
            ...
            <div id="tab-<?php echo $a; ?>">
                <div class="download-ciranda-txt">
                    ...
                    <?php if(get_field('rotulo_do_botao_aba_vertical')): ?>    
                        <a class="btn-padrao" href="<?php echo esc_url($linkBotaoAbaVertical_url); ?>" target="<?php echo esc_attr($linkBotaoAbaVertical_target); ?>"><?php the_field('rotulo_do_botao_aba_vertical'); ?></a>
                    <?php endif; ?>
                </div>
        ...
        <img class="download-ciranda-elemento-1" src="<?php echo bloginfo('template_directory');?>/img/passaros.png" alt="">
    </div>
</section>
<!-- HISTÓRIA -->
