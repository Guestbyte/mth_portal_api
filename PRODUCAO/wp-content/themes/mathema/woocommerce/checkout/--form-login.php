...
<button id="btn-login-cliente" class="btn-novo-cadastro">Login do Cliente<img id="seta-login-cliente" src="<?php echo bloginfo('template_directory');?>/img/seta-cadastro.png"></button>
...
<button id="btn-novo-cadastro" class="btn-novo-cadastro">Novo Cadastro<img id="seta-novo-cadastro" src="<?php echo bloginfo('template_directory');?>/img/seta-cadastro.png"></button>
