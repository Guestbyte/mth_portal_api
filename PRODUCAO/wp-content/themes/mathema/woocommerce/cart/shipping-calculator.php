...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form" style="display:block !important;">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_country', true ) ) : ?>
			<p class="calc_shipping_country_field" id="calc_shipping_country_field">
		...
		<div class="shipping-calculator-form-container">
			<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
					...
					<input type="text" class="input-text" value="<?php echo esc_attr( WC()->customer->get_shipping_postcode() ); ?>" placeholder="Informe o CEP" name="calc_shipping_postcode" id="calc_shipping_postcode" />
				
			<?php endif; ?>
			<button type="submit" name="calc_shipping" value="1" class="button">Calcular<?php // esc_html_e( 'Update', 'woocommerce' ); ?></button>
		</div>
