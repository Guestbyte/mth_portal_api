<?php /* Template Name: Ciranda Peças de Comunicação */ ?>
<!--HEADER-->
<?php get_header(); ?>
<!--LOOP WOOCOMMERCE-->
    ...
    <div class="woocommerce-MyAccount-content">
        ...
        <div class="woocommerce-MyAccount-content-inner">
            ...
            <div class="ciranda-interna-downloads">
                ...
                $images           = get_field( 'pecas_de_comunicacao_de_apoio' );
                $total            = count( $images );
                ...
                // ACF Loop
                if( have_rows( 'pecas_de_comunicacao_de_apoio' ) ) : ?>

                <?php while( have_rows( 'pecas_de_comunicacao_de_apoio' ) ): the_row();
                    ...
                    <div class="item-peca-comunicao">
                        <?php if(get_sub_field('arquivo_da_peca')): ?>
                            <a href="<?php the_sub_field('arquivo_da_peca'); ?>" target="_blank">
                        <?php else: ?>
                            <a href="<?php the_sub_field('link_externo'); ?>" target="_blank">
                        <?php endif; ?>

                            <?php echo wp_get_attachment_image( get_sub_field('imagem_da_peca' ), 'projeto-especial' ); ?>
                            <div class="titulo-peca-container">
                                <?php if(get_sub_field('arquivo_da_peca')): ?>
                                    <h6><?php the_sub_field('titulo_da_peca'); ?><br><span>com PDF</span></h6>
                                <?php else: ?>
                                    <h6><?php the_sub_field('titulo_da_peca'); ?><br><span>com Link Externo</span></h6>
                                <?php endif; ?>
